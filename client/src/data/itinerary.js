...
export const DAYS = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: '~5:30 PM', title: 'Dinner near MSG', detail: 'Penn Station / 7th Ave area — Girls pick!', status: 'plan', mealId: 'jun10-dinner' },
      { time: '6:15 PM', title: 'Arrive at MSG', detail: 'Madison Square Garden · Cashless venue', status: 'booked' },
  ...
  },
  {
    ...
    theme: 'Architecture + Water + Heights',
    emoji: '🏙️',
    color: 'amber',
    events: [
      { time: '~9:00 AM', title: 'Slow Morning', detail: 'Sleep in after the concert', status: 'free' },
      ...
      { time: '~6:00 PM', title: 'Dinner — Midtown', detail: 'Fuel up before Empire State Building — Girls pick!', status: 'plan', mealId: 'jun11-dinner' },
      { time: '8:00 PM', title: 'Empire State Building', detail: '86th floor · CityPASS Ref JGYJDMMS · Arrive at reserved time — no early entry', status: 'booked', ref: 'JGYJDMMS', warning: 'Do not arrive early — arrive at 8:00 PM exactly. No rainchecks once scanned.' },
      { time: '9:00 PM+', title: 'ESB Bonus Visit', detail: 'Free same-night return to 86th floor · No reservation needed · Until midnight!', status: 'bonus' },
    ],
  },
  {
    id: 'jun12',
